...
class LocationListView(DynamicTemplate, ListView):
    model = Location
...
class LocationCreateView(DynamicTemplate, CreateView):
...
class LocationDeleteView(DynamicTemplate, DeleteView):
...
class LocationUpdateView(DynamicTemplate, UpdateView):
